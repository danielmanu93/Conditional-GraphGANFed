...
def data_noniid(dataset, num_users):
    ...
    mol_data.generate('/vast/home/dmanu/Desktop/fedgan/data_smiles/qm8_smiles.pkl', validation=0.1, test=0.1)
    data = mol_data.data
...
if __name__ == '__main__':
    ...
    data.generate('/vast/home/dmanu/Desktop/fedgan/data_smiles/qm8_smiles.pkl', validation=0.1, test=0.1)
    data.save('/vast/home/dmanu/Desktop/fedgan/data_smiles/qm8.dataset')
